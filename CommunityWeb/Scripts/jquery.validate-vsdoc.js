...
$.extend($.validator, {
	...
	messages: {
	    ...
	    remote: "សូមកែ​ប្រែចន្លោះនេះ",
	    email: "សូមបំពេញអ៊ីម៉ែលឲបានត្រីមត្រូវ",
	    url: "សូមបំពេញURLឲបានត្រីមត្រូវ",
	    date: "សូមបំពេញថ្ងៃខែឲបានត្រីមត្រូវ",
		dateISO: "Please enter a valid date (ISO).",
		number: "សូមបំពេញលេខឲបានត្រីមត្រូវ",
		digits: "បំពេញបានតែលេខប៉ុណ្ណោះ",
		creditcard: "Please enter a valid credit card number.",
		equalTo: "Please enter the same value again.",
		accept: "Please enter a value with a valid extension.",
		maxlength: $.validator.format("បំពេញបានតែ {0} តូប៉ុណ្ណោះ"),
		minlength: $.validator.format("សូមបំពេញឲបានយ៉ាងតិច {0} តូ"),
		rangelength: $.validator.format("សូមបំពេញចន្លោះ {0} និង {1} តួ"),
		range: $.validator.format("សូមបំពេញតំលៃចន្លោះ {0} និង {1}."),
		max: $.validator.format("សូមបំពេញតំលៃតិចជាង​រឺស្មើរ {0}."),
		min: $.validator.format("សូមបំពេញតំលៃធំជាង​រឺស្មើរ {0}.")
	},
